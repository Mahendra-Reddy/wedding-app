              ...
              <Link to="/groom" className="profile">
                <div>
                  <img
                    ...
                    alt="PSK"
                  />
                  <label className="profile-name">Mahendra Reddy</label>
                </div>
              </Link>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <Link to="/bride" className="profile">
                <div>
                  <img
                    ...
                    alt=""
                  />
                  <label className="profile-name">Supriya Reddy</label>
                </div>
              </Link>
            </div>
          </div>
          <span
            className="d-flex justify-content-center invitation-heading"
          >
